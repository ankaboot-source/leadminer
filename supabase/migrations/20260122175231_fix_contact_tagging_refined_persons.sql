...
BEGIN
    ...
    CREATE TEMP TABLE grouped_tags AS
        ...
        HAVING 
        BOOL_OR(tg.source = 'refined#email_address' AND tg.reachable = 1)
        AND (
            -- Rule 2: Either they have NO message headers...
            NOT BOOL_OR(tg.source = 'refined#message_header')
            OR 
            -- OR if they DO have them, at least one is NOT 3
            BOOL_OR(tg.source = 'refined#message_header' AND tg.reachable != 3)
        );
