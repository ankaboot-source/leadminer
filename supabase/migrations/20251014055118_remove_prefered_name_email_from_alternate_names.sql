...
-- ============================================================
-- CHANGES FROM OLD:
-- - Supports multiple exclusions (exclude_array) instead of one value.
-- - Deduplicates case-insensitively but preserves original casing.
-- - Preserves original order.
-- - Excludes any element containing a substring from exclude_array.
-- ============================================================
...
-- ============================================================
-- REFINED_PERSON: alternate_name / alternate_email processing
-- ============================================================
-- CHANGE:
-- Previously:
--     - private.get_distinct_or_exclude_from_array(pn.alternate_name, pn.preferred_name)
--     - private.get_distinct_or_exclude_from_array( array_agg(upc.plus_address) ) AS alternate_email,

-- Current::
--     - private.get_distinct_or_exclude_from_array( pn.alternate_name, ARRAY[pn.preferred_name, ea.person_email])
--     - private.get_distinct_or_exclude_from_array( array_agg(upc.plus_address)::text[],   ARRAY[]::text[]) AS alternate_email,
--
-- Purpose: remove any alternate names containing the person's name or email.
-- ==
