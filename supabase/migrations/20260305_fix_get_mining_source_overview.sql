-- Ensure get_mining_source_overview function exists and is accessible
-- This addresses "Could not find the function private.get_mining_source_overview" error
...
-- Ensure authenticated role can execute this function
GRANT EXECUTE ON FUNCTION private.get_mining_source_overview(uuid) TO authenticated;
