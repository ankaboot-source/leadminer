...
describe('TasksManager', () => {
    ...
    describe('createTask()', () => {
        ...
        it('should throw an error if mining ID already exists', () => {
            ...
            expect(() => tasksManager.createTask(miningID, userID, fetcherInstance)).to.Throw(Error);
        });
    });
    ...
    describe('getActiveTask()', () => {
        ...
        it('should return the task object if it exists', () => {
            const userID = 'abc123';
            const miningId = tasksManager.generateMiningID(userID);        
            const createdTask = tasksManager.createTask(miningId, userID, fetcherInstance);
    ...
    describe('attachSSE()', () => {
        ...
        it('should attach an SSE instance to a mining task', () => {
            ...
            expect(tasksManager.getActiveTask(miningId).sseProgressHandler).eql(sseInstance);
        });
        ...
        it('should attach new instance and delete old if exists', () => {
            ...
            expect(tasksManager.getActiveTask(miningId).sseProgressHandler).eql(sseInstance2);
        });
        ...
        it('should throw an error if the task with the given mining ID does not exist', () => {
            ...
            expect( () => tasksManager.attachSSE(miningId, sseInstance)).to.Throw(Error);
        });
    });
