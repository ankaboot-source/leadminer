...
const headerRegexEamailSplitPattern =
  // eslint-disable-next-line security/detect-unsafe-regex
  /([\s\S]*?[^<,]+(?:<[^>]*>)?)\s*(?:,|$)/g;
const bodyRegex =
  // eslint-disable-next-line security/detect-unsafe-regex
...
module.exports = {
  ...
  REGEX_HEADER_EMAIL_SPLIT_PATTERN: headerRegexEamailSplitPattern, // // Regular expression pattern to split an email addresses.
