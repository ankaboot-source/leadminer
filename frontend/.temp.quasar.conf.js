  ...
  return {
    ...
    build: {
      ...
      env: {
        ...
        GG_CLIENT_ID: ctx.dev ? "$GG_CLIENT_ID" : "$GG_CLIENT_ID",
        SUPABASE_ID: ctx.dev ? "$SUPABASE_ID" : "$SUPABASE_ID",
        SUPABASE_TOKEN: ctx.dev ? "$SUPABASE_TOKEN" : "$SUPABASE_TOKEN",
      },
      // transpile: false,
    ...
    pwa: {
      ...
      manifest: {
        ...
        description: `leadminer: emails extractor`,
        display: "standalone",
