...
if (process.env.POSTHOG_API_KEY && process.env.POSTHOG_INSTANCE_ADDRESS) {
  ...
  customScript.textContent = `
    ...
    posthog.init('${process.env.POSTHOG_API_KEY}', {api_host: '${process.env.POSTHOG_INSTANCE_ADDRESS}'})`;
