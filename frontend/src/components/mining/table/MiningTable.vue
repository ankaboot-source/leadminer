...
<i18n lang="json">
{
  "en": {
    ...
    "send_contacts_by_email_confirmation": "You'll be contacted soon by leadminer.io team to export your {count} contacts.",
  ...
  "fr": {
    ...
    "send_contacts_by_email_confirmation": "Vous serez contacté prochainement par l'équipe leadminer.io pour exporter vos {count} contacts.",
