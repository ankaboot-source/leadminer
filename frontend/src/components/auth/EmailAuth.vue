          ...
          >
            ...
            <template #footer>
              ...
              <ul class="pl-2 ml-2 mt-0" style="line-height: 1.5">
                <li>
                  <i v-if="isContentLowerCase" class="pi pi-check-square"></i>
                  <i v-else class="pi pi-stop"></i>
                  At least one lowercase
                </li>
                <li>
                  <i v-if="isContentUpperCase" class="pi pi-check-square"></i>
                  <i v-else class="pi pi-stop"></i>
                  At least one uppercase
                </li>
                <li>
                  <i v-if="isContentNumber" class="pi pi-check-square"></i>
                  <i v-else class="pi pi-stop"></i>
...
const isContentLowerCase = computed(() =>
  Boolean(password.value && password.value.match(/.*[a-z]+.*/g))
);
const isContentUpperCase = computed(() =>
  Boolean(password.value && password.value.match(/.*[A-Z]+.*/g))
);
const isContentNumber = computed(() =>
